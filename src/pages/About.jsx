    ...
    <section id="about" className="min-h-screen bg-[#0b0b0c] text-white">
      <div className='w-full max-w-7xl mx-auto px-4 py-20'>
        <div className='flex flex-col items-center justify-center text-center'>
          <p className='text-[14px] md:text-[16px] font-[600] text-[#ffc107]' data-aos="fade-up">Know Me More</p>
          <h1 className='text-[24px] sm:text-[30px] xl:text-[35px] font-[700] uppercase' data-aos="fade-up">About Me</h1>
          <hr className='w-[1px] h-[3rem] bg-[#585b5c] border-none my-5' data-aos="fade-up" />
        </div>

        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10 px-4'>
          <div className='flex flex-col items-center text-center lg:text-left' data-aos="fade-up">
          ...
          <div className='text-[16px] sm:text-[24px] font-[400] md:leading-11 text-center lg:text-left' data-aos="fade-up">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto pt-10 lg:pt-20 px-4" data-aos="fade-up">
          {stats.map((stat, i) => (
